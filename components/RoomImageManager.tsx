...
export const RoomImageManager: React.FC<RoomImageManagerProps> = ({ images, onImagesChange }) => {
  ...
  return (
    <div>
      <h3 className="block text-sm font-medium text-gray-300 mb-2">Your Rooms ({images.length})</h3>
      ...
      />
       <p className="text-xs text-gray-500 mt-2">You can add multiple rooms or angles. Max 4MB per image.</p>
    </div>
  );
};